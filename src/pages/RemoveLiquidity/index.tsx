                      ...
                      {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                        <RowBetween style={{ justifyContent: 'flex-end' }}>
                          {oneCurrencyIsETH ? (
                            ...
                            >
                              {TranslateString(1188, 'Receive WXDAI')}
                            </StyledInternalLink>
                          ) : oneCurrencyIsWETH ? (
                            <StyledInternalLink
                              to={`/remove/${
                                currencyA && currencyEquals(currencyA, WETH[chainId]) ? 'XDAI' : currencyIdA
                              }/${currencyB && currencyEquals(currencyB, WETH[chainId]) ? 'XDAI' : currencyIdB}`}
                            >
                              {TranslateString(1190, 'Receive XDAI')}
                            </StyledInternalLink>
                          ) : null}
                        </RowBetween>
                      ) : null}
