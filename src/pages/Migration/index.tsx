        ...
        <Wrapper>
          ...
          <Card mb="32px">
            ...
            <CardBody>
              ...
              <Button as={Link} external href="https://bm.finance/#/pool" style={{ width: '100%' }}>
                Add liquidity
              </Button>
            </CardBody>
          </Card>
          ...
          <Card>
            <CardHeader>
              ...
              <Text small color="textSubtle">
                Stake your updated LP tokens in BMSwap farms
              </Text>
            </CardHeader>
            <CardBody>
              <Text mb="24px">
              ...
              <Button as={Link} external href="https://bm.finance/farms" style={{ width: '100%' }}>
                Go to farms
              </Button>
            </CardBody>
          </Card>
