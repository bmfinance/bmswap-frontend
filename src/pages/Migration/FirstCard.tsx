      ...
      <CardBody>
        ...
        <Card>
          <CardBody>
            ...
            <Button as={Link} external href="https://bm.finance/farms/history" style={{ width: '100%' }}>
              Go to Farms
            </Button>
          </CardBody>
        </Card>
        ...
        <Card>
          ...
          <FoldableContent isVisible={isVisible}>
            <Text mb="16px">
              You may need to unstake any BMSwap LP Tokens that you’ve staked in yield aggregators or other
